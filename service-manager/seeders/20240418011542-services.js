    ...
    await queryInterface.bulkInsert("services", [
      {
        ...
        host: "http://service-manager-ticketing",
        port: null,
      ...
      },
      {
        ...
        name: "Auth Service",
        host: "http://auth-service-ticketing",
        port: null,
      ...
      },
      {
        ...
        name: "Master Service",
        host: "http://master-service-ticketing",
        port: null,
      ...
      },
      {
        ...
        host: "http://storage-service-ticketing",
        port: null,
      ...
      },
      {
        ...
        name: "Log Service",
        host: "http://log-service-ticketing",
        port: null,
      ...
      },
      {
        ...
        name: "Event Service",
        host: "http://event-service-ticketing",
        port: null,
        apikey: "apikey6", // tambahkan apikey di sini
        is_maintenance: false,
        is_suspend: false,
        maintenance_message: "Event Service is Under Maintenance",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ]);
